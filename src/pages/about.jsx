...
const About = () => {
  ...
  const artisan = {
    ...
    email: "maya.purbasa.com",
    website: "www.purbasa.com",
    socialMedia: {
      instagram: "purbasa_handicrafts",
      facebook: "purbasaHandicrafts",
      twitter: "purbasa_crafts",
    },
    rating: 4.8,
    reviewCount: 127,
    specialty: "Block Printing",
    craftType: ["Handicrafts", "Bamboo Products", "Textiles", "Achaar", "Jewelry"],
    yearStarted: 1974,
